...
hidden if the `funsocket_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `funsocket_DEVELOPER_MODE` to the configure
...
Runs the executable target `funsocket_exe`.
